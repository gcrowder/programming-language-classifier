...
public class SimpleExample extends JPanel {
    ...
    JRadioButton aquaButton, metalButton, motifButton, windowsButton;
	...
	aquaButton = new JRadioButton(aqua);
        aquaButton.setMnemonic('a'); 
	aquaButton.setActionCommand(aquaClassName);
        aquaButton.setEnabled(isAvailableLookAndFeel(aquaClassName));
	...
	aquaButton.addActionListener(myListener);
